...
<body cz-shortcut-listen="true" style="background:#EEEAE7">
            ...
            <div style="justify-content: center;" class="row">
                <div style="max-width: 700px;" class="text-start">
                    <div class="section-jam">
                        <h3>Ninjam room</h3>
                        <p>Join to <b>lazapada.net:2049</b> with <a
                                href="https://github.com/elieserdejesus/JamTaba/wiki/Jamtaba%27s-user-guide"
                                target="_blank">Jamtaba</a>
                            or <a
                                href="https://drive.google.com/file/d/1EEuCw-Uboeoq_tkRgOkXBPoDfz6t9L1w/view?usp=sharing"
                                target="_blank">Reaper</a></p>
                        ...
                        <div class="listeners">
                            <label><span id="listeners_1">0</span>
                                listeners
                            </label>
                        </div>
<hr>
